...
<body>
	<div>
		...
		<div class="container">
			...
			<div class="card">
				<img src="/ServidorWeb/Imagenes?nombreImagen=<%= datavuelo.getImagen() != null ? datavuelo.getImagen() : "noimg.jpg" %>" alt="Imagen de vuelo">
				...
				<ul class="details-list">
					...
					<c:if test="${tipo == 'cliente'}">
						...
						<c:if test="${vueloReservado == 'no'}">
							<div class="opcionesClass">
								<a href="reservarServlet"
									class="btn btn-primary btn-success">Reservar</a>
							</div>
						</c:if>
					</c:if>
					...
					<c:if test="${tipo == 'aerolinea'}">
						<%
						String aerolineaLogeada = (String) request.getSession().getAttribute("usuario");
						if (datavuelo.getAerolinea().equals(aerolineaLogeada)) {
						%>
							<div class="opcionesClass">
								<a href="ListarReservasServlet"
									class="btn btn-primary btn-success">Consultar Reservas</a>
							</div>
						<%
						}
						%>
