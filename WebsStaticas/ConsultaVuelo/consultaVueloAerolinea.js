...
document
  ...
  `;
    ...
    if (document.getElementById("vuelo").value === "AR13801059") {
      document.getElementById("mostrarReservasBtn").style.display = "block";
    } else {
      document.getElementById("mostrarReservasBtn").style.display = "none";
      // También ocultar la tabla de reservas si se selecciona otra ruta
